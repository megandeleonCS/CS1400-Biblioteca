...
edad = int(input("Hola, Entre su edad: "))
fin_de_semana = input("Es fin de semana si/no: ")
fin_de_semana_m = fin_de_semana.lower()
el_precio_de_tu_entrada_es = 0
...
if edad < 12 and fin_de_semana_m=="si":
    precio =  5
elif edad < 12 and fin_de_semana_m=="no":
    precio = 3
elif edad > 65 and fin_de_semana_m=="si":
    precio = 6
elif edad > 65 and fin_de_semana_m=="no":
    precio = 4
else:
    if fin_de_semana_m =="si":
        precio = 10
    else:
        precio = 7
